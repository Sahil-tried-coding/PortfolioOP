...
function Contact() {
  // pt-[10.5rem]
  return (
    <div id="contact" className="#contact pt-[10rem]    w-[100vw] h-[100vh] bg-[#cbf]">
      ...
      <Link onClick={() => scroll.scrollToTop()}><BsFillArrowUpSquareFill className="ml-[10rem] animate-bounce sm:ml-[43rem] mr-[5rem]  mt-14 text-center text-4xl"/></Link> 
    </div>
  );
}
