...
function Contact() {
  // pt-[10.5rem]
  return (
    <div id="contact" className="#contact pt-[20rem]    w-[100vw] sm:h-[110vh] h-[103vh] bg-[#cbf]">
      ...
      <div className="flex gap-3  text-Rubik font-Inter  font-semibold text-lg text-white flex-col items-center justify-center sm:flex-row">
        ...
        <div className="bg-[#201737] sm:w-[400px] sm:mt-6 sm:mr-2 rounded-xl h-[170px] flex  flex-col items-center justify-center w-[80%] hover:scale-105 duration-500 ease-in">
